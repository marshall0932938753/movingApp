<?php
	...
	elseif (!strcmp("company_fix_discount",$func)) {
		$result[] = company_fix_discount($_POST['company_id']);
	}
	...
	elseif(!strcmp("all_vehicle_verified_data", $func)){
		$result[] = all_vehicle_verified_data($_POST['company_id']);
	}
	...
	elseif(!strcmp("announcement_company_data", $func)){
		$result[] = announcement_company_data($_POST['company_id']);
	}
	elseif(!strcmp("all_orders_data", $func)){
		$result[] = all_orders_data($_POST['company_id']);
	}
	elseif(!strcmp("all_company_member", $func)){
		$result[] = all_company_member($_POST['company_id']);
	}
	elseif(!strcmp("all_company_comment", $func)){
